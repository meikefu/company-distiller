---
name: byd-public-company-skill
description: "面向 public 受众、用途为 research 的 比亚迪 受治理公司对象 Skill。用于回答有证据支持的公司问题，开展商业关系、产品使用、风险和客户规划分析，并识别过期数据。"
---

# 比亚迪 公司 Skill

这是快照 `snapshot:byd:002` 面向 `public` 受众、服务于 `research` 用途的只读投影。
规范层的原始记录和事件不包含在本交付包中。

## 证据日期

- 快照创建时间：`2026-08-16T09:15:00+08:00`
- 最新纳入的观察时间：`2026-08-16T09:10:00+08:00`
- 受众：`public`
- 用途：`research`
